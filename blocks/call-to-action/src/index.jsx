/**
 * Call to Action — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Nothing here is interactive; clicking the button selects the block rather
				  * than following its link. The one thing to check on the real page is
				  * `column_split` - the ratio is of the row, and the canvas column is rarely
				  * the width the row will finally have.
				  */ }
