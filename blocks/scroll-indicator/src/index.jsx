/**
 * Scroll Indicator — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The bounce or pulse is held still, and clicking does not scroll to
				  * `target` - in the canvas that would scroll the EDITOR, not the page, to an
				  * element the editor may not even have rendered yet.
				  */ }
