/**
 * Post Meta Field — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * This element is DYNAMIC: it renders whatever post it finds itself in, at
				  * render time. In the editor that is the post being edited, so the canvas
				  * shows this post's own value - which on a new draft is often empty, and
				  * correctly so.
				  *
				  * In a Theme Builder template it stands for every post the template serves,
				  * and the canvas shows whichever post the preview resolves to.
				  */ }
