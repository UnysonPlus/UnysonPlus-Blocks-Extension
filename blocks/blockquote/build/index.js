(() => {
  // ../framework/extensions/gutenberg/blocks/blockquote/block.json
  var block_default = {
    $schema: "https://schemas.wp.org/trunk/block.json",
    apiVersion: 3,
    name: "unysonplus/blockquote",
    title: "Blockquote",
    category: "unysonplus",
    icon: "format-quote",
    description: "A pull quote with an author, role and source link \u2014 for testimonials, press quotes and callouts.",
    keywords: [
      "quote",
      "pullquote",
      "testimonial",
    ...
    editorScript: "fw-block-blockquote"
  };
