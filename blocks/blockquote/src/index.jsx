/**
 * Blockquote — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * replayed over it. `Disabled` keeps a click in the canvas selecting the
				  * block rather than following a link inside the element.
				  */ }
				<Disabled>
					<div
						ref={ previewRef }
