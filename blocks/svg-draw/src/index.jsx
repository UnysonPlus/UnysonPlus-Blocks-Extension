/**
 * SVG Draw — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The stroke is shown fully drawn rather than drawing itself. Replaying the
				  * draw-on would restart on every option change - so `duration` and `stagger`,
				  * the two settings you would actually be trying to judge, are the ones the
				  * preview would never hold still long enough to show.
				  */ }
