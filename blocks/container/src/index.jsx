/**
 * Container — the block editor half (a container).
 *
 * A width-constrained wrapper around other blocks - the plain version of
 * Section, without the dividers and effects.
