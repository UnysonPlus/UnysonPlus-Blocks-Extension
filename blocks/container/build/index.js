(() => {
  // ../framework/extensions/gutenberg/blocks/container/block.json
  var block_default = {
    $schema: "https://schemas.wp.org/trunk/block.json",
    apiVersion: 3,
    name: "unysonplus/container",
    title: "Container",
    category: "unysonplus",
    icon: "align-center",
    description: "A width-constrained wrapper around other blocks.",
    keywords: ["container", "wrapper", "width", "layout"],
    textdomain: "fw",
    attributes: {
      upOptions: {
        type: "object",
    ...
    editorScript: "fw-block-container"
  };
