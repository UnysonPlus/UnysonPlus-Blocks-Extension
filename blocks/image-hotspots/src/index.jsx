/**
 * Image Hotspots — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Pins do not open their popovers, and they cannot be dragged to reposition.
				  * Both gestures belong to the editor here - dragging would move the BLOCK.
				  * Pin coordinates are set per hotspot in the repeater in the sidebar.
				  */ }
