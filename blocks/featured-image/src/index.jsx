/**
 * Featured Image — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The image shown is THIS post's featured image, resolved at render time - so
				  * a draft with none set shows the element's own empty state rather than a
				  * placeholder that looks like a real picture.
				  */ }
