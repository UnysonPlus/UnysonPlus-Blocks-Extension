		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * There is nothing to hold still here; the element is static. Worth knowing
				  * instead: the icon's font is loaded into the canvas along with the element's
				  * stylesheet, so an icon that renders as a blank square in the editor is a
				  * missing icon pack rather than a broken block.
				  */ }
