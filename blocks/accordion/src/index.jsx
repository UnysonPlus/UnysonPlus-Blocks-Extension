/**
 * Accordion — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Panels do not open or close in the canvas: it shows whatever
				  * `initially_open` says, which is the state a visitor arrives to. Clicking a
				  * header would otherwise toggle a panel rather than select the block, and
				  * with `multiple_open` off, opening one would close another - a preview that
				  * changes what it is previewing.
				  *
				  * Edit panel content in the Items repeater in the sidebar.
				  */ }
