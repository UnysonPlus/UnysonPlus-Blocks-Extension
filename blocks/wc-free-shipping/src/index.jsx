/**
 * Free Shipping Bar — the block editor half (no settings).
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The cart panel does not open, and its contents are the EDITING USER's cart,
				  * not a sample: this element renders whatever is in the session it is
				  * rendered for. An empty cart here is your cart being empty.
				  */ }
				<Disabled>
