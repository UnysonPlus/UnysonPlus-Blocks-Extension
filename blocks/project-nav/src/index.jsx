/**
 * Project Navigation — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Previous / next links do not navigate in the canvas; clicking selects the
				  * block. Which projects they point at depends on the project being viewed, so
				  * in a template the canvas shows the neighbours of whichever project the
				  * preview resolved to.
				  */ }
