(() => {
  // ../framework/extensions/gutenberg/blocks/project-nav/block.json
  var block_default = {
    $schema: "https://schemas.wp.org/trunk/block.json",
    apiVersion: 3,
    name: "unysonplus/project-nav",
    title: "Project Navigation",
    category: "unysonplus",
    icon: "leftright",
    description: "Previous and next links between projects.",
    keywords: ["project", "navigation", "previous", "next", "portfolio"],
    textdomain: "fw",
    attributes: {
      upOptions: {
        type: "object",
    ...
    editorScript: "fw-block-project-nav"
  };
