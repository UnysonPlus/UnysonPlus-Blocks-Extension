/**
 * Carousel — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The carousel does not advance, and dragging does not scroll it. Both would
				  * be the same gesture the editor uses to select and move a block, and the
				  * canvas shows the first slide held so that option changes do not restart a
				  * rotation you were mid-way through watching.
				  *
				  * Slides are edited in the repeater in the sidebar.
				  */ }
