		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Nothing here moves, so the canvas is the finished element. What it CANNOT
				  * show is a status dot fed by presence data: `show_status` renders whatever
				  * the source says at render time, which in an editor is usually nothing.
				  */ }
