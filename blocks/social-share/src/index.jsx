/**
 * Social Share — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Live, these are real share links: a click in the canvas would open a share
				  * dialog for the post you are in the middle of writing - usually still a
				  * draft, and often not at the URL it will finally live at.
				  *
				  * That is also why the preview's links may not match the front end's. With
				  * `share_source` set to the current page, the URL is resolved at render time,
				  * and a draft has no final permalink yet.
				  */ }
