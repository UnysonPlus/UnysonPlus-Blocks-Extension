/**
 * WebGL Object — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * No WebGL context is created in the canvas. That is the expensive kind of
				  * inert: a live object would run a render loop behind the editor, hold a GPU
				  * context, and start a fresh one on every re-render - several at once, since
				  * nothing tears the old ones down promptly.
				  *
				  * The canvas shows `poster` where one is set. Set one.
				  */ }
