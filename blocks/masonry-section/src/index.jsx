/**
 * Masonry Section — the block editor half (a container).
 *
 * A masonry section: children flow into a staggered multi-column layout.
 *
 * The canvas stacks them normally instead. Masonry positions are computed from
 * the rendered heights of real content, which the editor's own layout does not
 * reproduce - so the arrangement you see here is not the one visitors get.
