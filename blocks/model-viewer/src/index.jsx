/**
 * 3D Model — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The 3D model is NOT loaded into the canvas. That is the expensive kind of
				  * inert: a live viewer would download the model file and spin up WebGL in the
				  * editor, and do it again on every re-render. The canvas shows the poster
				  * image, which is what a visitor sees before the model loads anyway.
				  */ }
