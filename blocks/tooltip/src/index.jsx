		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The consequence worth stating: the canvas shows the TRIGGER, not the tip.
				  * The tooltip markup is rendered but stays hidden, exactly as it is on a real
				  * page before anyone hovers. To check the tip's wording and position, preview
				  * the page.
				  *
				  * Leaving it live would be worse than useless - with `event` set to hover,
				  * the tip would open every time the pointer crossed the block on its way to
				  * something else.
				  */ }
