/**
 * Scroll to Top — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The button pins itself to the viewport, which in the canvas is the editor's
				  * IFRAME - so it sits inside the canvas rather than over the editor chrome.
				  * It does not appear or disappear on scroll here, and clicking does not
				  * scroll the editor.
				  */ }
