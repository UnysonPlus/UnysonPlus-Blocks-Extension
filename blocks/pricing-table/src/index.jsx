/**
 * Pricing Table — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The billing toggle does not switch. It is a real control on the front end,
				  * and here it would change which prices are displayed - so the preview would
				  * show one set of numbers while the sidebar was editing the other.
				  */ }
