		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Nothing here animates or reorders itself, so the preview is a faithful
				  * picture of the finished element. The one thing to know is that the step
				  * NUMBERS come from position in the list, not from anything you type - move
				  * a step and it renumbers.
				  */ }
