(() => {
  // ../framework/extensions/gutenberg/blocks/tag-list/block.json
  var block_default = {
    $schema: "https://schemas.wp.org/trunk/block.json",
    apiVersion: 3,
    name: "unysonplus/tag-list",
    title: "Tag List",
    category: "unysonplus",
    icon: "tag",
    description: "A row of small tags from a list of lines \u2014 keywords, categories, skills or filters.",
    keywords: [
      "tags",
      "keywords",
      "chips",
    ...
    editorScript: "fw-block-tag-list"
  };
