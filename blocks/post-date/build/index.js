(() => {
  // ../framework/extensions/gutenberg/blocks/post-date/block.json
  var block_default = {
    $schema: "https://schemas.wp.org/trunk/block.json",
    apiVersion: 3,
    name: "unysonplus/post-date",
    title: "Post Date",
    category: "unysonplus",
    icon: "calendar",
    description: "The current post's published or modified date.",
    keywords: ["post date", "published", "modified", "dynamic", "theme builder"],
    textdomain: "fw",
    attributes: {
      upOptions: {
        type: "object",
    ...
    editorScript: "fw-block-post-date"
  };
