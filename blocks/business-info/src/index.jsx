/**
 * Business Info — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * `show_status` prints an Open now / Closed badge computed from the current
				  * time against the opening hours - so the preview shows the status AT THE
				  * MOMENT IT RENDERED, in the site's timezone, not a fixed value. It is real,
				  * it is just not a preview of any particular time.
				  */ }
