/**
 * Progress — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Bars are drawn at their FINAL value rather than animating up to it.
				  * Replaying the fill would restart on every option change, so the number you
				  * are trying to set would be the one thing the preview never held still long
				  * enough to show.
				  */ }
