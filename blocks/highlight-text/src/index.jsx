/**
 * Highlight Text — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The highlight effect draws itself when it scrolls into view, so the canvas
				  * shows the finished state rather than the draw-on. That is the useful
				  * preview: it is what a reader sees a moment after the text arrives, and it
				  * does not replay every time an option changes.
				  */ }
