/**
 * Comparison Table — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * `sticky_header` pins the header row as the table scrolls. In the canvas the
				  * scrolling container is the editor's IFRAME, so it sticks relative to that
				  * rather than to the page - the behaviour is real, the frame of reference is
				  * not the visitor's.
				  */ }
