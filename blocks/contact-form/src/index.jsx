/**
 * Contact Form — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The form does not submit, and that matters more here than anywhere else:
				  * live, a stray Enter in the canvas would send a real message to the address
				  * in `email_to`, from the editor, while someone was still building the form.
				  *
				  * The nonce is minted per render, so the copy in this preview belongs to the
				  * editing session and a visitor's is minted fresh when their page is served.
				  */ }
