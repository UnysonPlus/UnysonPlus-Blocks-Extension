		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Clicking the image selects the block rather than following `link`, and the
				  * `fetchpriority` hint has no observable effect in a canvas - it is a
				  * loading-order instruction to the browser on a real page view.
				  */ }
