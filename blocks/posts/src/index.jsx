		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The query runs for real, so the canvas shows actual posts from this site -
				  * which is the useful preview, and the reason this block is worth having over
				  * a static mock.
				  *
				  * Two things it does not do: pagination does not paginate, and the live
				  * filters do not filter. Both would replace the preview's contents with a
				  * different set of posts and leave you unsure which query you were looking
				  * at.
				  */ }
