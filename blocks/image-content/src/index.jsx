/**
 * Image + Content — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The `breakpoint` and `mobile_order` settings decide what happens at widths
				  * the canvas is not currently at, so they cannot be judged here at all. That
				  * is not a limitation of the preview so much as of any single-width view -
				  * check them in a page preview, narrow.
				  */ }
