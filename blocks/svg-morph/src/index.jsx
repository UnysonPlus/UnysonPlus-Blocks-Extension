/**
 * SVG Morph — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The first shape is shown, held. Replaying the morph would restart on every
				  * option change, so `easing` and the shape ORDER - the two things you would
				  * be trying to judge - are exactly what the preview would never settle on
				  * long enough to show.
				  */ }
