/**
 * Logo Grid — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * With `autoplay` on, the row scrolls continuously on the front end. It is
				  * held still here: a marquee running behind the sidebar you are typing in is
				  * a distraction rather than a preview, and it would restart on every
				  * option change anyway.
				  */ }
