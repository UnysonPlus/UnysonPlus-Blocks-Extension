		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Nothing here is interactive, so the preview is exactly the element. The one
				  * thing worth knowing is that a divider's WIDTH is relative to its container:
				  * in the canvas that is the block's own column, which may be narrower or
				  * wider than the column it will finally sit in.
				  */ }
