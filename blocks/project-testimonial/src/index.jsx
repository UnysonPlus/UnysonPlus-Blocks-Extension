/**
 * Project Testimonial — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * A single-project element. It reads the project it finds itself in, so in a
				  * Theme Builder project template the canvas shows whichever project the
				  * preview resolves to - and with `project_id` set, that specific one.
				  */ }
