/**
 * Product Filters — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Filters do not filter in the canvas. They act on the product grid they
				  * accompany, and a preview that changed which products were listed would stop
				  * being a preview of the grid you are editing.
				  */ }
