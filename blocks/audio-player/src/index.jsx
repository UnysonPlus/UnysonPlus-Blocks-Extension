/**
 * Audio Player — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Nothing plays here, and `autoplay` in particular is neutralised: a player
				  * that started on its own would begin again on every re-render, which in a
				  * block editor means on every keystroke in the sidebar. The canvas shows the
				  * player at rest.
				  */ }
