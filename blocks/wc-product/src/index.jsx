/**
 * Single Product — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Add-to-cart is inert for the same reason it is on the grid: a click would
				  * put a product in the editing user's real cart.
				  */ }
