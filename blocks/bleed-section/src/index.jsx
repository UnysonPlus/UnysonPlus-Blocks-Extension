/**
 * Bleed Section — the block editor half (a container).
 *
 * A section with an image bleeding off one edge, holding content on the other.
 *
 * The bleed image is not shown in the canvas - only the editable content side,
 * inside a neutral outline.
