(() => {
  // ../framework/extensions/gutenberg/blocks/button/block.json
  var block_default = {
    ...
    category: "unysonplus",
    icon: "button",
    description: "A link button with presets, sizes, icons and hover effects.",
    keywords: ["button", "cta", "link", "action", "call to action"],
    textdomain: "fw",
    attributes: {
      upOptions: {
        type: "object",
