		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Clicking selects the block; it does not follow `link`. And `hover_animation`
				  * is the option the canvas cannot show at rest - the pointer has to land on
				  * the block to select it, so a live effect would fire constantly while you
				  * work. Hover the rows in the Hover Animation control to compare effects.
				  */ }
