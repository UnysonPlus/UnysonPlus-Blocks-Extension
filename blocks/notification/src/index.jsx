/**
 * Notification — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Two of this element's behaviours would otherwise be actively hostile in an
				  * editor: the close button would let you dismiss the block you are editing,
				  * and `auto_dismiss` would make it vanish a few seconds after every render.
				  * Neither is a preview of anything.
				  *
				  * A `display_mode` of bar-top or floating pins the notice to the viewport.
				  * In the canvas that viewport is the editor's IFRAME, so it pins inside the
				  * canvas rather than over the editor chrome - the layout is honest, and the
				  * editor stays usable.
				  */ }
