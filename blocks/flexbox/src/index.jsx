/**
 * Flexbox — the block editor half (a container).
 *
 * A flex container. Holds other blocks and arranges them along an axis.
 *
 * `direction`, `justify_content` and `align_items` are exactly what the canvas
 * outline cannot show, since the children are laid out by the editor rather than
 * by the element's own CSS. This is the container where previewing the page
 * matters most.
