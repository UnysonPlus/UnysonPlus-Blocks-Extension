(() => {
  // ../framework/extensions/gutenberg/blocks/widget-area/block.json
  var block_default = {
    $schema: "https://schemas.wp.org/trunk/block.json",
    apiVersion: 3,
    name: "unysonplus/widget-area",
    title: "Widget Area",
    category: "unysonplus",
    icon: "screenoptions",
    description: "A registered sidebar, rendered inline.",
    keywords: ["widget", "sidebar", "widget area"],
    textdomain: "fw",
    attributes: {
      upOptions: {
        type: "object",
    ...
    editorScript: "fw-block-widget-area"
  };
