		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The video does not play and, for an embedded source, is not loaded at all:
				  * a live embed would pull the provider's player into the editor and reload it
				  * on every re-render. The canvas shows the element's frame at the chosen
				  * ratio.
				  */ }
