/**
 * Countdown — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The timer does not tick. It renders the remaining time AT THE MOMENT of
				  * render, which for a target in the past is the completed state - so an
				  * expired countdown previews as expired, which is the honest answer.
				  *
				  * A ticking preview would also re-render on every tick, which in a block
				  * editor is a repaint per second for as long as the sidebar is open.
				  */ }
