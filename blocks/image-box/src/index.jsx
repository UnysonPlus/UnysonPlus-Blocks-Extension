/**
 * Image Box — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * `hover_effect` is the thing you cannot see here: the canvas shows the
				  * resting state, because the pointer landing on the block to select it would
				  * otherwise trigger the effect every time - the preview would spend most of
				  * its life showing you the hover rather than the page.
				  */ }
