/**
 * Product Categories — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The query runs for real, so the canvas shows this shop's actual products.
				  * Add-to-cart does nothing here: live, a click would add a product to the
				  * EDITOR's session cart, which is a real cart belonging to whoever is logged
				  * in.
				  */ }
