/**
 * Text Block — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * This is the block where the inert preview costs the most, and it is worth
				  * being plain about: the text is NOT edited in the canvas. It is edited in
				  * the sidebar's rich-text field, and the canvas shows the result.
				  *
				  * That is the price of one renderer rather than two. Core's Paragraph block
				  * is the right tool for ordinary prose; this element earns its place when you
				  * want its typographic controls - columns, drop caps, balance, lead - which
				  * core does not have.
				  */ }
