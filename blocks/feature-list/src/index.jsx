/**
 * Feature List — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Nothing here is interactive, so the canvas is a faithful picture of the
				  * finished element. `columns` is the setting to check in a page preview
				  * rather than here: the canvas column is rarely the width of the column the
				  * list will finally sit in.
				  */ }
