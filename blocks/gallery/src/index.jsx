		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * A lightbox does not open on click, and a carousel design does not advance.
				  * Both would take the click the editor needs for selecting the block.
				  *
				  * Worth knowing about the empty state: with the source set to a post's
				  * attached media, the canvas shows what THIS post has attached - which for a
				  * new draft is usually nothing at all.
				  */ }
