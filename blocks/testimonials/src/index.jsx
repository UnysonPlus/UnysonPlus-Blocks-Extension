/**
 * Testimonials — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * A carousel design does not advance here. It shows the first slide, held: a
				  * preview that rotated every few seconds would move while you were reading
				  * the sidebar, and it would restart on every option change.
				  */ }
