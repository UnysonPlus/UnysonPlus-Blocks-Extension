/**
 * Flip Box — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The card does not flip, and it shows the FRONT. With `trigger` set to
				  * hover, a live preview would flip every time the pointer crossed the block
				  * on its way to something else - and the back face would be showing exactly
				  * when you clicked to select it.
				  *
				  * Both faces are edited in the sidebar, which is where their content lives
				  * regardless of which one the canvas happens to show.
				  */ }
