(() => {
  // ../framework/extensions/gutenberg/blocks/map/block.json
  var block_default = {
    ...
    category: "unysonplus",
    icon: "location-alt",
    description: "An embedded map with markers, from your chosen provider.",
    keywords: ["map", "location", "address", "directions", "google maps", "openstreetmap"],
    textdomain: "fw",
    attributes: {
      upOptions: {
        type: "object",
