		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * A map is the one element where an inert preview is also the CHEAP one: a
				  * live embed would load the provider's script and tiles into the editor,
				  * count against the API quota, and do it again on every re-render. The canvas
				  * shows the element's own placeholder frame instead.
				  */ }
