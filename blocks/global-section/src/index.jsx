/**
 * Global Section — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The canvas shows the CHOSEN snippet's current content, rendered fresh. So
				  * this preview is the one that can change without the block changing: edit
				  * the snippet elsewhere and every block pointing at it shows the new version
				  * next time it renders. That is the entire point of the element.
				  */ }
