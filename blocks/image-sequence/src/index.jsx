/**
 * Image Sequence — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * This one is scroll-DRIVEN rather than merely scroll-triggered: the frame
				  * shown is a function of scroll position, and it pins the viewport while it
				  * plays. Live in a canvas, that would hijack the editor's own scrolling to
				  * step through frames - you would lose the ability to scroll past the block.
				  *
				  * The canvas shows the first frame, unpinned.
				  */ }
