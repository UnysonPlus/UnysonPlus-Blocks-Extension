(() => {
  // ../framework/extensions/gutenberg/blocks/wc-checkout/block.json
  var block_default = {
    $schema: "https://schemas.wp.org/trunk/block.json",
    apiVersion: 3,
    name: "unysonplus/wc-checkout",
    title: "Checkout",
    category: "unysonplus",
    icon: "cart",
    description: "WooCommerce's checkout.",
    keywords: ["checkout", "payment", "order", "woocommerce"],
    textdomain: "fw",
    attributes: {
      upOptions: {
        type: "object",
    ...
    editorScript: "fw-block-wc-checkout"
  };
