(() => {
  // ../framework/extensions/gutenberg/blocks/wc-cart/block.json
  var block_default = {
    $schema: "https://schemas.wp.org/trunk/block.json",
    apiVersion: 3,
    name: "unysonplus/wc-cart",
    title: "Cart",
    category: "unysonplus",
    icon: "cart",
    description: "WooCommerce's cart page.",
    keywords: ["cart", "basket", "woocommerce", "cart page"],
    textdomain: "fw",
    attributes: {
      upOptions: {
        type: "object",
