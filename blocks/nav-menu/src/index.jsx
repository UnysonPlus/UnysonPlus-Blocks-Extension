/**
 * Navigation Menu — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Site chrome: it renders from SITE settings, not from the post. The canvas
				  * shows the real thing - the real menu, the real logo - because there is
				  * nothing post-specific to resolve.
				  *
				  * Clicking does not navigate: in the editor that would leave the post being
				  * edited.
				  */ }
