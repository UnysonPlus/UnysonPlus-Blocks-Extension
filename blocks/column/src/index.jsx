/**
 * Column — the block editor half (a container).
 *
 * A column inside a row. Holds other blocks, and the canvas shows them editable
 * inside a neutral outline rather than at the column's real width.
 *
 * That last part matters more here than for the other containers: `col_width` is
 * the whole point of a column, and it is the one thing this preview cannot show.
