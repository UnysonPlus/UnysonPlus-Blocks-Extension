/**
 * Section — the block editor half (a container).
 *
 * A full-width band that holds other blocks. The canvas shows a neutral outline
 * with the real, editable children inside it - not the section's own background,
 * padding or design preset, which PHP applies on the front end.
 *
 * `background` is a background-pro value: five stacked layers, none of which the
 * outline reproduces. Preview the page to see the section as a visitor does.
