(() => {
  // ../framework/extensions/gutenberg/blocks/post-excerpt/block.json
  var block_default = {
    $schema: "https://schemas.wp.org/trunk/block.json",
    apiVersion: 3,
    name: "unysonplus/post-excerpt",
    title: "Post Excerpt",
    category: "unysonplus",
    icon: "excerpt-view",
    description: "The current post's excerpt.",
    keywords: ["excerpt", "summary", "dynamic", "theme builder"],
    textdomain: "fw",
    attributes: {
      upOptions: {
        type: "object",
    ...
    editorScript: "fw-block-post-excerpt"
  };
