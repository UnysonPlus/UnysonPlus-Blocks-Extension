/**
 * Table of Contents — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * A table of contents built from the headings of the page it sits on - and in
				  * a block editor those headings live in OTHER blocks, which the server does
				  * not see while rendering this one. So the canvas shows the element's own
				  * placeholder rather than a list that would be wrong.
				  *
				  * This is the one block whose preview genuinely cannot be accurate. Preview
				  * the page to see the real contents.
				  */ }
