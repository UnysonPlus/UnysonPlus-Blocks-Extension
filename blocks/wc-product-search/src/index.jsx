/**
 * Product Search — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The field does not accept typing and the form does not submit - a search
				  * from inside the editor would navigate away from the post being written.
				  */ }
