(() => {
  // ../framework/extensions/gutenberg/blocks/calendar/block.json
  var block_default = {
    $schema: "https://schemas.wp.org/trunk/block.json",
    apiVersion: 3,
    name: "unysonplus/calendar",
    title: "Calendar",
    category: "unysonplus",
    icon: "calendar-alt",
    description: "A month calendar with events, and an optional upcoming list.",
    keywords: ["calendar", "events", "dates", "schedule", "month", "agenda"],
    textdomain: "fw",
    attributes: {
      upOptions: {
        type: "object",
    ...
    editorScript: "fw-block-calendar"
  };
