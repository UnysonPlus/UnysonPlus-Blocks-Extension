/**
 * Calendar — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The month shown is the month it is TODAY, and `highlight`-style styling for
				  * the current day is computed at render time. So the preview is honest but
				  * not fixed: it will look different next month without anyone editing it.
				  */ }
