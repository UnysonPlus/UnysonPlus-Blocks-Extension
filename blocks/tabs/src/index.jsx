		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The canvas shows the FIRST tab, open. Clicking a tab in the preview would
				  * otherwise switch panels rather than select the block, which is the same
				  * gesture meaning two different things - and the one it would not mean is
				  * the one the editor needs.
				  *
				  * To read the other panels, expand them in the Tabs repeater in the sidebar:
				  * that is where their content actually lives.
				  */ }
