(() => {
  // ../framework/extensions/gutenberg/blocks/menu-toggle/block.json
  var block_default = {
    $schema: "https://schemas.wp.org/trunk/block.json",
    apiVersion: 3,
    name: "unysonplus/menu-toggle",
    title: "Menu Toggle",
    category: "unysonplus",
    icon: "menu-alt",
    description: "A hamburger button that opens a menu.",
    keywords: ["hamburger", "menu button", "toggle", "mobile menu"],
    textdomain: "fw",
    attributes: {
      upOptions: {
        type: "object",
    ...
    editorScript: "fw-block-menu-toggle"
  };
