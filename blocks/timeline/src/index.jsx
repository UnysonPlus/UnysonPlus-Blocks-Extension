/**
 * Timeline — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Entries reveal themselves as they scroll into view on the front end. The
				  * canvas shows them all revealed, because a preview that hid half its
				  * content until you scrolled the editor past it would be showing you less
				  * than you are editing.
				  */ }
