/**
 * Team Member — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Nothing here is interactive; the canvas is the finished card. The card's
				  * ROWS - which of name, role, description and links appear, and in what order
				  * - are the repeater in the sidebar, not something to drag in the preview.
				  */ }
