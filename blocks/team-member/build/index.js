(() => {
  // ../framework/extensions/gutenberg/blocks/team-member/block.json
  var block_default = {
    $schema: "https://schemas.wp.org/trunk/block.json",
    apiVersion: 3,
    name: "unysonplus/team-member",
    title: "Team Member",
    category: "unysonplus",
    icon: "businessperson",
    description: "A person card - photo, name, role, description and links.",
    keywords: ["team", "person", "staff", "profile", "bio", "about us"],
    textdomain: "fw",
    attributes: {
      upOptions: {
        type: "object",
    ...
    editorScript: "fw-block-team-member"
  };
