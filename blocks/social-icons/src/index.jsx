/**
 * Social Icons — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Live, these are real links to real profiles, and a click in the canvas
				  * would navigate away from the post you are editing.
				  */ }
