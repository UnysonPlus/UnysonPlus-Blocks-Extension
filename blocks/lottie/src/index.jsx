		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The animation does not play, and with `trigger` set to hover it would
				  * otherwise fire every time the pointer crossed the block on its way to
				  * something else. The canvas shows the first frame.
				  */ }
