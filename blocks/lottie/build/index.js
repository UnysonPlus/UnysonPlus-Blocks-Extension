(() => {
  // ../framework/extensions/gutenberg/blocks/lottie/block.json
  var block_default = {
    $schema: "https://schemas.wp.org/trunk/block.json",
    apiVersion: 3,
    name: "unysonplus/lottie",
    title: "Lottie",
    category: "unysonplus",
    icon: "format-video",
    description: "A Lottie animation - JSON from a file or a URL - with playback triggers.",
    keywords: ["lottie", "animation", "json", "motion", "icon animation", "bodymovin"],
    textdomain: "fw",
    attributes: {
      upOptions: {
        type: "object",
