/**
 * Star Rating — the block editor half.
 *
...
registerBlockType( metadata.name, {
	edit( { attributes, setAttributes } ) {
		...
		/*
		 * No "not configured yet" state: `rating` defaults to 4.5, so a freshly
		 * inserted block already renders a real rating. No Placeholder branch.
		 */
		return (
			<div { ...blockProps }>
				<Inspector
				...
				{ /*
				  ...
				  * copy of it. Star Rating renders entirely server-side and ships no
				  * front-end JS at all, so there is no runtime to replay here — the
				  * markup the server returns IS the finished element.
				  *
