/**
 * Code Block — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The code renders exactly as it will on the page, including highlighting if
				  * the element applies any. What differs is the EDITING: the sidebar field is
				  * a plain monospace textarea rather than the page builder's CodeMirror - see
				  * the code-editor control for why wrapping CodeMirror in React risks eating
				  * the buffer.
				  */ }
