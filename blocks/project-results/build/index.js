(() => {
  // ../framework/extensions/gutenberg/blocks/project-results/block.json
  var block_default = {
    $schema: "https://schemas.wp.org/trunk/block.json",
    apiVersion: 3,
    name: "unysonplus/project-results",
    title: "Project Results",
    category: "unysonplus",
    icon: "chart-bar",
    description: "A project's results or outcome figures.",
    keywords: ["project", "results", "outcomes", "stats", "portfolio"],
    textdomain: "fw",
    attributes: {
      upOptions: {
        type: "object",
    ...
    editorScript: "fw-block-project-results"
  };
