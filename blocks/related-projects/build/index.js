(() => {
  // ../framework/extensions/gutenberg/blocks/related-projects/block.json
  var block_default = {
    $schema: "https://schemas.wp.org/trunk/block.json",
    apiVersion: 3,
    name: "unysonplus/related-projects",
    title: "Related Projects",
    category: "unysonplus",
    icon: "screenoptions",
    description: "Other projects related to this one.",
    keywords: ["related", "projects", "portfolio", "more work"],
    textdomain: "fw",
    attributes: {
      upOptions: {
        type: "object",
    ...
    editorScript: "fw-block-related-projects"
  };
