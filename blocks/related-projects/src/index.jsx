/**
 * Related Projects — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * The query runs for real, so the canvas shows this site's actual projects.
				  * What it does not do is filter or paginate: both replace what the grid is
				  * showing, and a preview that swaps its own contents stops being a preview of
