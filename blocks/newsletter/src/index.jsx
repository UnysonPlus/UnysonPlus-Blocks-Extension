/**
 * Newsletter — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * replayed over it.
				  *
				  * `Disabled` matters more here than for the other blocks: this element is a
				  * real FORM with a real submit handler. Left live, clicking into the email
				  * field to see how it looks would put focus in a form rather than select the
				  * block, and a stray Enter would fire an actual subscribe request — against
				  * the rate limiter, from the editor, for whoever is logged in.
				  *
				  * The security nonce is generated by the view on every render, so the copy in
				  * this preview belongs to the editing session and the copy a visitor receives
				  * is minted fresh when their page is served. Nothing stale is ever stored.
				  */ }
				<Disabled>
					<div
						ref={ previewRef }
