(() => {
  // ../framework/extensions/gutenberg/blocks/modal-popup/block.json
  var block_default = {
    $schema: "https://schemas.wp.org/trunk/block.json",
    apiVersion: 3,
    name: "unysonplus/modal-popup",
    title: "Modal Popup",
    category: "unysonplus",
    icon: "external",
    description: "A button, link, icon or image that opens content in a modal dialog.",
    keywords: ["modal", "popup", "lightbox", "dialog", "overlay"],
    textdomain: "fw",
    attributes: {
      upOptions: {
        type: "object",
    ...
    editorScript: "fw-block-modal-popup"
  };
