/**
 * Modal Popup — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * For this block that has a consequence worth stating: the canvas shows the
				  * TRIGGER, not the modal. The dialog markup is rendered but stays hidden,
				  * exactly as it is on a front-end page before anyone clicks. To see the
				  * modal itself, preview the page.
				  *
				  * That is also why `Disabled` is not optional here. `open_on_load` is a real
				  * option, and a live preview of a popup set to open automatically would
				  * cover the editor with a dialog every time the block re-rendered — which is
				  * to say, on every keystroke in the sidebar.
				  */ }
				<Disabled>
					<div
						ref={ previewRef }
