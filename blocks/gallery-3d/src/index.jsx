/**
 * 3D Gallery — the block editor half.
 *
		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * No WebGL context is created in the canvas: a live 3D scene would hold a GPU
				  * context and run a render loop behind the editor, starting a fresh one on
				  * every re-render.
				  *
				  * The page builder offers a live scene preview inside its options modal
				  * (`design_preview`). That is not reproduced here, and does not need to be -
				  * the block canvas already previews the real element rendered by the real
				  * PHP, so a second approximate scene beside it would only be one more thing
				  * that can disagree.
				  */ }
