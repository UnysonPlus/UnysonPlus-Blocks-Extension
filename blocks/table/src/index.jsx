		...
		return (
			<div { ...blockProps }>
				...
				{ /*
				  ...
				  * working copy.
				  *
				  * Sorting, searching and pagination do not work in the canvas. All three
				  * replace what the table is showing, which in an editor means the preview
				  * stops being a preview of the rows you are editing.
				  *
				  * Cells are edited in the sidebar's table control, not in the canvas: the
				  * server-rendered preview is markup, not an editable grid.
				  */ }
